...
const initialComplaints: Complaint[] = [
  {
    ...
    location: {
      latitude: 14.321458,
      longitude: 121.099812,
    },
    images: [{ uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }],
  ...
  },
  {
    ...
    location: {
      latitude: 14.316250,
      longitude: 121.098654,
    },
    images: [{ uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }],
...
const initialProjects: Project[] = [
  ...
  },
  {
    ...
    images: [{ uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }, { uri: `https://picsum.photos/seed/${Math.random()}/400/250` }],
